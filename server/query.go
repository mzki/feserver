...
func parseGetQuestionQuery(v url.Values) (src.Query, error) {
	q := src.Query{}
...
func parseGetRandomQuery(v url.Values) (src.QueryRange, error) {
	qr := src.DefaultQueryRange
